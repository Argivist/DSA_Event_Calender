...
public class Month {
    ...
    public static void main(String[] args) {
        ...
        Day d = new Day(1);
        Day d1 = new Day(2);
        Event e = new Event("12-03", LocalTime.of(12,0), LocalTime.of(12,0), "Walking", "move to a place");
        Event e1 = new Event("9-11", LocalTime.of(2, 30), LocalTime.of(12,0), "Running", "levitating");
        Event e2 = new Event("3-4", LocalTime.of(3, 30),  LocalTime.of(12,0),"Swimming", "swim to a place");
        Event e3 = new Event("4-5", LocalTime.of(4, 30), LocalTime.of(12,0), "Cycling", "cycle to a place");
        Event e4 = new Event("5-6", LocalTime.of(5, 30),  LocalTime.of(12,0),"Driving", "drive to a place");
        d.addEvent(e);
        d.addEvent(e1);
        d.addEvent(e2);
        d.addEvent(e3);
